...
function init() {
  ...
  scene.applyMatrix4( new THREE.Matrix4().makeTranslation(-5.75, -9, 0));
  ...
  pointLight = new THREE.PointLight(0xf23557, 3);
  pointLight.position.set(-50, 50, -20)
  scene.add(pointLight);

  pointLight2 = new THREE.PointLight(0x393c83, 8);
  pointLight2.position.set(50, 50, -20);
  scene.add(pointLight2);

  pointLight3 = new THREE.PointLight(0x22b2da, 2);
  pointLight3.position.set(-50, 0, 0);
  scene.add(pointLight3);

  pointLight4 = new THREE.PointLight(0xc4c4c4, 4);
  ...
  // set id for renderer
  renderer.domElement.id = 'mic-canvas'
  ...
  loader.load("./model/microphone/scene.gltf", function (gltf) {
